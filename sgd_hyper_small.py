...
lambdas_ = [10, 1]  # Regularization parameter
max_iter = 10000  # Number of iterations for the SGD algorithm
...
for lambda_ in lambdas_:
    ...
    file_path = './sgd_news_all_min_accuracies' + str(lambda_) + '.txt'
    with open(file_path, 'w') as file:
        for element in accuracies:
            file.write(f"{element:.15f}\n") 
